...
void ShaderHandler::CreateProgram(const std::string& shaderName_, const std::string& vertexShaderFilePath_, const std::string& fragmentShaderPath_) {
	std::string vertexShaderCode = ReadShader(vertexShaderFilePath_);
	std::string fragmentShaderCode = ReadShader(fragmentShaderPath_);
